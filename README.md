[![Build Status](https://github.com/opspec-pkgs/git.repo.tags.list/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/git.repo.tags.list/actions?query=workflow%3Abuild+branch%3Amain)
